...
const LandingPage = () => {
  ...
  return (
    <div ref={containerRef} className="relative min-h-screen bg-void-navy overflow-hidden flex flex-col font-sans">
      ...
      {/* Hero Content */}
      <main className="relative z-10 flex flex-col items-center justify-center px-6 pt-16 pb-24 max-w-6xl mx-auto text-center flex-grow">
        ...
        {/* Video Frame */}
        <div className="video-container relative w-full max-w-6xl mx-auto mb-16 rounded-md border border-white/10 bg-void-depth shadow-2xl overflow-hidden">
